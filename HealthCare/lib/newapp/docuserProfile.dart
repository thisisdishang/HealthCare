...
class DocUserProfile extends StatefulWidget {
  const DocUserProfile({Key? key}) : super(key: key);

  @override
  _DocUserProfileState createState() => _DocUserProfileState();
}
...
class _DocUserProfileState extends State<DocUserProfile> {
  //
  // final CollectionReference firebase =
  // FirebaseFirestore.instance.collection('doctor');
  // var appointment = FirebaseFirestore.instance;
